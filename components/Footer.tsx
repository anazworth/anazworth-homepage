...
function Footer() {
    ...
    {/* Vim Status Bar Left-Side */}
        <div className="flex flex-row truncate">
            ...
            <FolderIcon className="h-6 w-4 ml-2 hidden sm:inline overflow-hidden"/>
            <h1 className="ml-2 hidden sm:inline overflow-hidden">anazworth</h1>
    ...
    {/* Vim Status Bar Right-Side*/}
        <div className="flex flex-row flex-nowrap truncate content-center">
            <h1 className="mx-2 hidden sm:inline overflow-hidden">utf-8 [unix]</h1>
